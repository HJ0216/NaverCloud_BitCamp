...
function checkId() {
	...
	if(idValue=="") {
		...
		window.open("/mvcMember/member/checkId.do?id="+idValue,"checkId","width=500 height=300 left=900 top=200")
...
<script src="http://localhost:8080/mvcMember/js/member.js"></script>
