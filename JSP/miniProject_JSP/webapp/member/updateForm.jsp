...
<form name="updateForm" method="post" action="http://localhost:8080/miniProject_JSP/member/update.jsp">
...
<script src="http://localhost:8080/miniProject_JSP/js/member.js">
