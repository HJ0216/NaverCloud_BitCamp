...
<form name="boardWriteForm" method="post" action="/mvcBoard/board/write.do">

<h3>WRITE FORM</h3>

<table border="1" cellpadding="5" cellspacing="0">

	<tr><td colspan="2"><input type="text" name="name" id="name"></td></tr>
	<tr><td colspan="2"><input type="text" name="id" id="id"></td></tr>
	<tr><td colspan="2"><input type="text" name="email" id="email"></td></tr>
